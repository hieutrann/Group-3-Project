...
namespace Sentiment_AnalysisML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\hieut\Desktop\sentiment labelled sentences\sentiment labelled sentences\yelp_labelled.txt";
        private static string MODEL_FILEPATH = @"C:\Users\hieut\AppData\Local\Temp\MLVSTools\Sentiment AnalysisML\Sentiment AnalysisML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options() { L2Regularization = 0.9678827f, L1Regularization = 0.235783f, OptimizationTolerance = 0.0001f, HistorySize = 20, MaximumNumberOfIterations = 583297795, InitialWeightsDiameter = 0.8391026f, DenseOptimizer = true, LabelColumnName = "Label", FeatureColumnName = "Features" });
